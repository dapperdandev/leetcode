...
import { arrayToRandomList, randomListToArray } from "../../../lib/structures.ts";
import { copyRandomList } from "./copy-list-with-random-pointer.ts";

describe("138. Copy List with Random Pointer", () => {
    it("example 1", () => {
        const head = arrayToRandomList([
            [7, null],
            [13, 0],
            [11, 4],
            [10, 2],
        ...
        expect(randomListToArray(copyRandomList(head))).toEqual([
            [7, null],
            [13, 0],
            [11, 4],
            [10, 2],
